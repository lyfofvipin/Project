...
class Profile(LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # context['pro_form'] = self.second_form_class(self.request.POST, instance=self.object.user)
        context['title'] = 'Profile | Post'
        return context

    # def form_valid(self, form):
    #     pro_form = UserProfileUpdateForm(self.request.POST, instance=self.object.user)
